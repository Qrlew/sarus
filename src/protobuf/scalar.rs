...
pub mod scalar {
    ...
    pub mod model {
        ...
        impl ::protobuf::Enum for ModelClass {
            ...
            fn from_str(str: &str) -> ::std::option::Option<ModelClass> {
                match str {
                    "TF_KERAS" => ::std::option::Option::Some(ModelClass::TF_KERAS),
                    "SK_SVC" => ::std::option::Option::Some(ModelClass::SK_SVC),
                    "SK_ONEHOT" => ::std::option::Option::Some(ModelClass::SK_ONEHOT),
                    "SK_PCA" => ::std::option::Option::Some(ModelClass::SK_PCA),
                    "SK_AFFINITY_PROPAGATION" => ::std::option::Option::Some(ModelClass::SK_AFFINITY_PROPAGATION),
                    "SK_AGGLOMERATIVE_CLUSTERING" => ::std::option::Option::Some(ModelClass::SK_AGGLOMERATIVE_CLUSTERING),
                    "SK_BIRCH" => ::std::option::Option::Some(ModelClass::SK_BIRCH),
                    "SK_DBSCAN" => ::std::option::Option::Some(ModelClass::SK_DBSCAN),
                    "SK_FEATURE_AGGLOMERATION" => ::std::option::Option::Some(ModelClass::SK_FEATURE_AGGLOMERATION),
                    "SK_KMEANS" => ::std::option::Option::Some(ModelClass::SK_KMEANS),
                    "SK_MINIBATCH_KMEANS" => ::std::option::Option::Some(ModelClass::SK_MINIBATCH_KMEANS),
                    "SK_MEAN_SHIFT" => ::std::option::Option::Some(ModelClass::SK_MEAN_SHIFT),
                    "SK_OPTICS" => ::std::option::Option::Some(ModelClass::SK_OPTICS),
                    "SK_SPECTRAL_CLUSTERING" => ::std::option::Option::Some(ModelClass::SK_SPECTRAL_CLUSTERING),
                    "SK_SPECTRAL_BICLUSTERING" => ::std::option::Option::Some(ModelClass::SK_SPECTRAL_BICLUSTERING),
                    "SK_SPECTRAL_COCLUSTERING" => ::std::option::Option::Some(ModelClass::SK_SPECTRAL_COCLUSTERING),
                    "SK_ADABOOST_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_ADABOOST_CLASSIFIER),
                    "SK_ADABOOST_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_ADABOOST_REGRESSOR),
                    "SK_BAGGING_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_BAGGING_CLASSIFIER),
                    "SK_BAGGING_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_BAGGING_REGRESSOR),
                    "SK_EXTRA_TREES_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_EXTRA_TREES_REGRESSOR),
                    "SK_EXTRA_TREES_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_EXTRA_TREES_CLASSIFIER),
                    "SK_GRADIENT_BOOSTING_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_GRADIENT_BOOSTING_CLASSIFIER),
                    "SK_GRADIENT_BOOSTING_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_GRADIENT_BOOSTING_REGRESSOR),
                    "SK_ISOLATION_FOREST" => ::std::option::Option::Some(ModelClass::SK_ISOLATION_FOREST),
                    "SK_RANDOM_FOREST_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_RANDOM_FOREST_CLASSIFIER),
                    "SK_RANDOM_FOREST_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_RANDOM_FOREST_REGRESSOR),
                    "SK_RANDOM_TREES_EMBEDDING" => ::std::option::Option::Some(ModelClass::SK_RANDOM_TREES_EMBEDDING),
                    "SK_STACKING_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_STACKING_CLASSIFIER),
                    "SK_STACKING_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_STACKING_REGRESSOR),
                    "SK_VOTING_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_VOTING_CLASSIFIER),
                    "SK_VOTING_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_VOTING_REGRESSOR),
                    "SK_HIST_GRADIENT_BOOSTING_REGRESSOR" => ::std::option::Option::Some(ModelClass::SK_HIST_GRADIENT_BOOSTING_REGRESSOR),
                    "SK_HIST_GRADIENT_BOOSTING_CLASSIFIER" => ::std::option::Option::Some(ModelClass::SK_HIST_GRADIENT_BOOSTING_CLASSIFIER),
                    "SK_REPEATED_STRATIFIED_KFOLD" => ::std::option::Option::Some(ModelClass::SK_REPEATED_STRATIFIED_KFOLD),
                    "XGB_CLASSIFIER" => ::std::option::Option::Some(ModelClass::XGB_CLASSIFIER),
                    "SK_LABEL_ENCODER" => ::std::option::Option::Some(ModelClass::SK_LABEL_ENCODER),
                    "SK_KFOLD" => ::std::option::Option::Some(ModelClass::SK_KFOLD),
                    _ => ::std::option::Option::None
                }
            }
