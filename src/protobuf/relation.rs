...
//! Generated file from `sarus_data_spec/protobuf/relation.proto`
...
// @@protoc_insertion_point(message:sarus_data_spec.Relation)
pub struct Relation {
    // message fields
    // @@protoc_insertion_point(field:sarus_data_spec.Relation.uuid)
    pub uuid: ::std::string::String,
    // @@protoc_insertion_point(field:sarus_data_spec.Relation.name)
    pub name: ::std::string::String,
    // @@protoc_insertion_point(field:sarus_data_spec.Relation.arguments)
    pub arguments: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:sarus_data_spec.Relation.named_arguments)
    pub named_arguments: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:sarus_data_spec.Relation.properties)
    pub properties: ::std::collections::HashMap<::std::string::String, ::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:sarus_data_spec.Relation.special_fields)
...
impl Relation {
    ...
    pub fn named_arguments(&self) -> &[::std::string::String] {
    ...
    // Param is passed by value, moved
    pub fn set_named_arguments(&mut self, v: ::std::vec::Vec<::std::string::String>) {
        self.named_arguments = v;
    }

    // Mutable pointer to the field.
    pub fn mut_named_arguments(&mut self) -> &mut ::std::vec::Vec<::std::string::String> {
        &mut self.named_arguments
    }

    // Take field
    pub fn take_named_arguments(&mut self) -> ::std::vec::Vec<::std::string::String> {
        ::std::mem::replace(&mut self.named_arguments, ::std::vec::Vec::new())
    }

    // repeated .sarus_data_spec.Relation.PropertiesEntry properties = 5;
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "arguments",
            |m: &Relation| { &m.arguments },
            |m: &mut Relation| { &mut m.arguments },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "named_arguments",
            |m: &Relation| { &m.named_arguments },
            |m: &mut Relation| { &mut m.named_arguments },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_map_simpler_accessor::<_, _, _>(
            "properties",
            |m: &Relation| { &m.properties },
            |m: &mut Relation| { &mut m.properties },
        ));
...
impl ::protobuf::Message for Relation {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.named_arguments.push(is.read_string()?);
                },
                42 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.named_arguments {
    ...
    fn default_instance() -> &'static Relation {
        static instance: ::protobuf::rt::Lazy<Relation> = ::protobuf::rt::Lazy::new();
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n'sarus_data_spec/protobuf/relation.proto\x12\x0fsarus_data_spec\"\x83\
    \x02\n\x08Relation\x12\x12\n\x04uuid\x18\x01\x20\x01(\tR\x04uuid\x12\x12\
    \n\x04name\x18\x02\x20\x01(\tR\x04name\x12\x1c\n\targuments\x18\x03\x20\
    \x03(\tR\targuments\x12'\n\x0fnamed_arguments\x18\x04\x20\x03(\tR\x0enam\
    edArguments\x12I\n\nproperties\x18\x05\x20\x03(\x0b2).sarus_data_spec.Re\
    lation.PropertiesEntryR\nproperties\x1a=\n\x0fPropertiesEntry\x12\x10\n\
